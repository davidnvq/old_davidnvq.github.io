...
$(document).ready(function(){
	...
	function generatePrevLabCarousel() {
		...
		$car.carouFredSel({
			...
			scroll: {
				...
				onBefore: function( data ) {
					var $comming = data.items.visible.eq(1),
						$going = data.items.old.eq(1),
						$commingdetail = $("div#prev-lab-details div").eq($comming.data('index')),
						$goingdetail = $("div#prev-lab-details div").eq($going.data('index'));
	...
	generatePrevLabCarousel();

	function generateVisitLabCarousel() {
		...
		$car.carouFredSel({
			...
			scroll: {
				...
				onBefore: function( data ) {
					var $comming = data.items.visible.eq(1),
						$going = data.items.old.eq(1),
						$commingdetail = $("div#visit-lab-details div").eq($comming.data('index')),
						$goingdetail = $("div#visit-lab-details div").eq($going.data('index'));
	...
	/* publication site carousel*/
	function generatepubsiteCarousel() {
		...
		$car.carouFredSel({
			...
			scroll: {
				...
				onBefore: function( data ) {
					var $comming = data.items.visible.eq(1),
						$going = data.items.old.eq(1),
						$commingdetail = $("div#pubsite-details div").eq($comming.data('index')),
						$goingdetail = $("div#pubsite-details div").eq($going.data('index'));
